...
TEST(optix_data_tests, data_remove_optics)
{
    SETUP_TEST_CXT();
...
TEST(optix_data_tests, data_remove_elements)
{
    SETUP_TEST_CXT();
...
TEST(optix_data_tests, data_toggle_element)
{
    SETUP_TEST_CXT();
...
TEST(optix_data_tests, data_element_xyz)
{
    SETUP_TEST_CXT();
...
TEST(optix_data_tests, data_element_aim)
{
    SETUP_TEST_CXT();
...
TEST(optix_data_tests, data_element_zrot)
{
    SETUP_TEST_CXT();
...
TEST(optix_data_tests, data_element_aperture)
{
    SETUP_TEST_CXT();
...
TEST(optix_data_tests, data_element_surface)
{
    SETUP_TEST_CXT();
...
TEST(optix_data_tests, data_element_optic)
{
    SETUP_TEST_CXT();
